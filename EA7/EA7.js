var app = ( function() {
	...
	function initModels() {
        // fillstyle
        var fs = "fill";
		createModel("torus", fs, [ 1, 1, 1, 1 ], [ 0, 1, 0 ], [ 0.5* Math.PI, 0, 0 ], [2.5, 4, 2.5 ]);
		createModel("torus", fs, [ 1, 1, 1, 1 ], [ 0, 1, 0 ], [ Math.PI, 0, 0 ], [4, 2.5, 2.5 ]);
		createModel("torus", fs, [ 1, 1, 1, 1 ], [ 0, 1, 0 ], [ 0, 0, 0 ], [2.5, 4,2.5 ]);
		createModel("torus", fs, [ 1, 1, 1, 1 ], [ 0, 1, 0 ], [ 0.5* Math.PI, 0, 0 ], [0.5, 1, 1 ]);
		createModel("torus", fs, [ 1, 1, 1, 1 ], [ 0, 1, 0 ], [ Math.PI, 0, 0 ], [1, 0.5, 1 ]);
		createModel("torus", fs, [ 1, 1, 1, 1 ], [ 0, 1, 0 ], [ 0, 0,0 ], [0.5, 1, 1 ]);
